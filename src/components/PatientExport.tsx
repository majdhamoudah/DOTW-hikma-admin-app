...
const PatientExport = (props: any) => {
  ...
  const searchPatients = async () => {
    fetch(`http://dotw-hikma.azurewebsites.net/admin_api/search_patients`, {
      method: 'POST',
      headers: {
        Authorization: token
      },
  ...
  const handleExportAllPatients = () => {
    fetch(`http://dotw-hikma.azurewebsites.net/admin_api/export`, {
      method: 'POST',
      headers: {
        Authorization: token
      }
  ...
  const handleExportSinglePatient = (patientId: string) => {
    fetch(`http://dotw-hikma.azurewebsites.net/admin_api/export_patient`, {
      method: 'POST',
      headers: {
        Authorization: token
      },
